...
export const TOOLS: readonly FerramentaCard[] = [
  ...
  },
  {
    ...
    desc: "Diagnóstico editorial do livro inteiro, capítulo a capítulo.",
    categoria: "Análise e texto",
    estado: "pago",
    preco_creditos: CUSTOS_CREDITOS.diagnostico,
  ...
  },
  {
    ...
    preco_copy: {
      principal: `R$ ${CUSTOS_CREDITOS.capa_avulsa}`,
      sufixo: "inclui 4 gerações",
      secundario: `extras R$ ${CUSTOS_CREDITOS.capa_avulsa_imagem} · 4 por R$ ${CUSTOS_CREDITOS.capa_avulsa_pacote}`,
      creditos: `${CUSTOS_CREDITOS.capa_avulsa} créditos · extras ${CUSTOS_CREDITOS.capa_avulsa_imagem} cada`,
    },
    icon: SparkleIcon,
  },
