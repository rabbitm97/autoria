...
// Núcleo puro de segmentação + tipos vivem em lib/segmentar-capitulos.ts
// (não pode ter node:crypto: entra em bundle client via miolo-builder).
// Reexportados aqui para os consumidores existentes (gerar-epub etc.).
import type { Chapter } from "./segmentar-capitulos";
export type { Chapter, CapituloAprovado } from "./segmentar-capitulos";
export { segmentByCapitulosAprovados } from "./segmentar-capitulos";
