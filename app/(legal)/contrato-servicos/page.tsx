  ...
  return (
    <LegalDocFrame slug="contrato-servicos">
      ...
      <section id="clausula-6">
        ...
        <p className="mb-3"><strong>6.1.</strong> A impressão é executada por gráfica parceira — atualmente <strong>Graphium Editora Ltda</strong> (CNPJ 55.222.483/0001-60) —, sob responsabilidade técnica da AUTORIA perante o AUTOR. A AUTORIA pode substituir a gráfica parceira mediante aviso prévio no painel do projeto, mantendo o padrão de qualidade contratado.</p>
        <p className="mb-3"><strong>6.2. Prazos de produção</strong> contam a partir da aprovação da prova e da confirmação do pagamento, variando conforme a tiragem: até <strong>300 exemplares</strong>, até <strong>15 dias úteis</strong>; acima de <strong>300 exemplares</strong>, até <strong>20 dias úteis</strong>. Os prazos não incluem o transporte, cujo prazo e valor são informados no momento do pedido.</p>
      ...
      <section id="clausula-7">
        ...
        <p><strong>7.5. Autorização expressa de produção.</strong> O livro impresso é produto <strong>personalizado sob encomenda</strong>. A produção gráfica somente inicia mediante <strong>autorização expressa</strong> do AUTOR no momento do pedido, prestada com a informação clara de que, iniciada a produção, o valor da impressão não é reembolsável — inclusive dentro do prazo da Cláusula 7.2 —, salvo defeito nos termos da Cláusula 6. Antes do início da produção, o cancelamento do pedido de impressão tem <strong>reembolso integral</strong>, a qualquer tempo.</p>
      </section>
