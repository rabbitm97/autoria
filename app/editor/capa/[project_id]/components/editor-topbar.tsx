...
export function EditorTopbar({ projectData, onSaveRetry }: EditorTopbarProps) {
  ...
  const { legendasAtivas, toggleLegendas, stageInstance, format, pages, orelhaMm, layout } = useEditorStore();
  ...
  async function handleOpenPreview() {
    ...
    if (stageInstance) {
      try {
        const url = await captureStageAsDataUrl(stageInstance, format, pages, orelhaMm, layout);
