...
import VerificadorPdfTool from "@/components/ferramentas/verificador-pdf-tool";

export const metadata: Metadata = {
  title: "Verificador de PDF para impressão de livro — grátis | Autoria",
  description:
    "Confira grátis se o PDF do seu livro está pronto pra gráfica: formato, sangria, marcas de corte e páginas. Análise no navegador — seu arquivo não é enviado.",
};

export default function VerificadorPdfPage() {
  return (
