...
import LombadaPaginasTool from "@/components/ferramentas/lombada-paginas-tool";

export const metadata: Metadata = {
  title: "Calculadora de lombada e páginas de livro — grátis | Autoria",
  description:
    "Calcule a lombada do seu livro pelo papel e estime quantas páginas o texto vai render em cada formato. Grátis, direto no navegador, sem cadastro.",
};

export default function LombadaPaginasPublicPage() {
  return (
