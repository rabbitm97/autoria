...
// PROVA-SSR-01: react-pdf referencia DOMMatrix (API de navegador) na
// avaliação do módulo — só pode carregar no cliente. ssr:false mantém
// a avaliação fora do servidor; sem isso a página inteira aborta o
// stream (React #419, digest 114743516, 17/ago).
const PdfFolheador = dynamic(() => import("./pdf-folheador"), {
  ssr: false,
  loading: () => (
    <div className="flex items-center justify-center py-16">
      <span className="w-5 h-5 rounded-full border-2 border-brand-gold border-t-transparent animate-spin" />
    </div>
  ),
});
