      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-zinc-100 p-6 space-y-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <label className="block text-xs font-semibold text-zinc-400 uppercase tracking-wide">Manuscrito</label>
            <ManuscriptUpload onText={setTexto} />
          </div>
          <textarea
            value={texto}
            onChange={e => setTexto(e.target.value)}
            placeholder="Cole o texto completo ou envie um arquivo PDF, DOCX ou TXT acima. Títulos de capítulos em LETRAS MAIÚSCULAS..."
            rows={12}
